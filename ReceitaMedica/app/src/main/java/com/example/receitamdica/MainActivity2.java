package com.example.receitamdica;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void doRecuperar(View view) {
        TextView txtNomeDoPaciente = findViewById(R.id.textNomePaciente);
        txtNomeDoPaciente.setText(getPreference("nome"));

        TextView txtReceita = findViewById(R.id.textReceita);
        txtReceita.setText(recuperaDadoArquivo(getIntent().getStringExtra("fileName")));
    }
}