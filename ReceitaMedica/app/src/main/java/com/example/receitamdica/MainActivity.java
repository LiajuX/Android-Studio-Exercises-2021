...
public class MainActivity extends AppCompatActivity {
    ...
    public void doGravar(View view) {
        ...
        EditText txtNomeDoPaciente = findViewById(R.id.inputNomePaciente);
        addPreference("nome", txtNomeDoPaciente.getText().toString());

        EditText txtReceita = findViewById(R.id.inputReceita);
        gravaDadoArquivo(fileName, txtReceita.getText().toString());
